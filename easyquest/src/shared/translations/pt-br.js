...
export default {
  ...
  helpMessage: {
    ...
    creators:
      'Esta aplicação foi desenvolvida no Departamento de Ciência da Computação do Instituto de Ciências Exatas e Tecnológicas (DCC/ICET) da -, em parceria com sua Coordenadoria de Educação a Distância (CEAD).',
  },
};
